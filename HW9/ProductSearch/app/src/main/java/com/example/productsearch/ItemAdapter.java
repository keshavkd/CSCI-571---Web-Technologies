...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.MyViewHolder> {
    ...
    private List<ProductItems> listItems;
    ...
    public ItemAdapter(Context mC, List<ProductItems> lItems) {
        this.mContext = mC;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        ...
        holder.titlex.setText(listItems.get(position).getTitle());

        RequestOptions options = new RequestOptions()
                .placeholder(R.mipmap.ic_launcher_round)
                .error(R.mipmap.ic_launcher_round);
        String imgURL = listItems.get(position).getImg();
...
//        GlideApp.with(mContext).load(imgURL).placeholder(R.mipmap.ic_launcher_round).into(holder.imgx);
        ...
        holder.zipx.setText(listItems.get(position).getZipc());
        holder.condx.setText(listItems.get(position).getCondc());
        holder.shipx.setText(listItems.get(position).getShipc());
        holder.pricex.setText(listItems.get(position).getPrice());

        holder.gObj = listItems.get(position).getDemiItem();
        holder.itemID = listItems.get(position).getItemId();
        holder.shipVal = listItems.get(position).getShipc();
        holder.titleVal = listItems.get(position).getTitle();
        holder.zipVal = listItems.get(position).getZipc();
        holder.priceVal = listItems.get(position).getPrice();
        holder.condVal = listItems.get(position).getCondc();
        holder.imgVal = listItems.get(position).getImg();
        ...
        try {
                ...
                if (xtemp.equals(holder.itemID)) {
                    ...
                    holder.igx.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            removeFromList(holder, holder.itemID);
                        }
                    });
                    break;
                }
            ...
            if (i == ogJS.size()) {
                ...
                holder.igx.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        addToList(holder, holder.itemID);
                    }
                });
            }
    ...
    public void removeFromList(MyViewHolder holder, String id) {
        final MyViewHolder hx = holder;
        try {
            FileInputStream fs = new FileInputStream(new File(mContext.getFilesDir(), filename));
            ObjectInputStream os = new ObjectInputStream(fs);
            List<Entry> ogJS = (List<Entry>)os.readObject();
    ...
    public void addToList(MyViewHolder holder, String id) {
        final MyViewHolder hx = holder;
        try {
